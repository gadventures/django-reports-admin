...
class CSVGenerator(object):
    '''
    Utility for generating CSV output from a dictionary of fields
    with callables or values. Note, the order of fields will only be
    preserved if the `fields` dictionary is an OrderedDict.
